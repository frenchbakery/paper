...
\begin{itemize}
    ...
    \item Provide additional, commonly used communication schemes such as Remote Procedure Calls (RPCs) that further simplify common use cases of network communication for the developer
\end{itemize}
